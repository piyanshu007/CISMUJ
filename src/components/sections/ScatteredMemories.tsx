...
export const ScatteredMemories: React.FC = () => {
  ...
  return (
    <section className="relative w-full bg-white text-[#0F172A] py-16 sm:py-24 overflow-hidden select-none border-b border-slate-100">
      ...
      {/* ============================================================ */}
      <div className="lg:hidden px-4 sm:px-6 space-y-12 max-w-2xl mx-auto">
        {/* Header Block */}
        <div className="space-y-3 text-center sm:text-left">
          ...
          <h2 className="font-sans font-light text-4xl sm:text-5xl tracking-tight text-slate-900 leading-tight">
            Ideas become <br />
            <span className="text-[#0284C7] font-normal">experiences.</span>
          </h2>
        ...
        <div className="space-y-10 relative">
          <div className="absolute left-6 top-8 bottom-8 w-0.5 bg-gradient-to-b from-sky-400 via-sky-300 to-sky-100 -z-0" />
          ...
          {EVENTS.map((event, idx) => (
            <motion.div
              ...
              className="relative z-10 pl-14 sm:pl-16 space-y-4"
            >
              {/* Waypoint Circle */}
              <div className="absolute left-4 top-2 -translate-x-1/2 w-4 h-4 rounded-full border-2 border-[#0284C7] bg-white flex items-center justify-center">
              ...
              <div
                onClick={() => setSelectedEvent(event)}
                className="aspect-[16/10] w-full rounded-2xl overflow-hidden shadow-md border border-slate-100 cursor-pointer bg-slate-100"
              >
                <img
                  src={event.image}
                  alt={event.title}
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <span className="font-sans text-xs text-slate-500 font-normal">
                    {event.year}
                  </span>
                </div>

                <div className="space-y-1 font-mono text-[10px] sm:text-xs text-slate-500 uppercase font-semibold">
                  <p className="flex items-center gap-1.5">
                ...
                <button
                  onClick={() => setSelectedEvent(event)}
                  className="font-mono text-xs font-bold text-[#0284C7] uppercase tracking-wider flex items-center gap-1.5 pt-1"
                >
                  <span>VIEW EVENT</span>
