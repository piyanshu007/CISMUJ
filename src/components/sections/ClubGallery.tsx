...
const galleryItems: GalleryItem[] = [
  ...
  {
    id: 'hackerzstreet',
    title: 'HACKERZSTREET 4.0: 24-HOUR NATIONAL HACKATHON',
    category: 'FLAGSHIP HACKATHON',
    date: 'MARCH 2025',
    venue: 'TMA PAI AUDITORIUM, MUJ',
    attendees: '500+ PARTICIPANTS',
    image: '/events/hackerzstreet.jpg',
    description: 'National 24-hour hackathon bringing together students to engineer hardware, AI pipelines, and decentralized apps.',
  },
  {
    id: 'oneiros',
    ...
    date: 'NOVEMBER 2024',
    venue: 'MAIN UNIVERSITY GROUNDS, MUJ',
    attendees: '5000+ ATTENDEES',
    image: '/events/oneiros.jpg',
    description: 'Annual campus tech celebration featuring drone light canopy shows, robotics exhibitions, and student talent.',
  },
  {
    id: 'cybermafia',
    title: 'CYBER MAFIA: STRATEGY & CTF ARENA',
    category: 'TECHNICAL LAB',
    date: 'DECEMBER 2024',
    venue: 'INNOVATION LOUNGE, MUJ',
    attendees: '160+ COMPETITORS',
    image: '/events/cybermafia.jpg',
    description: 'Adversarial cybersecurity challenge where teams solved cryptography clues and competed in real-time deduction.',
  },
  {
    id: 'genify',
    title: 'GENIFY: GENERATIVE AI MASTERCLASS',
    category: 'AI MASTERCLASS',
    date: 'JANUARY 2025',
    venue: 'CS BLOCK LAB 4, MUJ',
    attendees: '140+ ATTENDEES',
    image: '/events/genify_ai.jpg',
    description: 'Hands-on session on transformer attention math, diffusion model pipelines, and fine-tuning open-weight foundation models.',
  },
  {
    id: 'fostering_future',
    title: 'FOSTERING THE FUTURE: ALUMNI TECH TALK',
    category: 'AI MASTERCLASS',
    date: 'APRIL 2025',
    venue: 'MAIN AUDITORIUM, MUJ',
    attendees: '300+ STUDENTS',
    image: '/events/fostering_future.jpg',
    description: 'Annual flagship technical speaker symposium connecting student engineers with pioneering industry leaders.',
  },
  {
    id: 'team_awards',
  ...
  {
    id: 'orientation',
    title: 'FRESHERS RECRUITMENT & ORIENTATION',
    category: 'COMMUNITY INDUCTION',
    date: 'SEPTEMBER 2024',
