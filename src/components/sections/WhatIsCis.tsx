...
export const WhatIsCis: React.FC = () => {
  return (
    <section className="relative w-full bg-white text-[#0F172A] overflow-hidden select-none">
      ...
      {/* ============================================================ */}
      {/* ============================================================ */}
      {/* PART 2: OUR FOCUS SECTION                                    */}
      {/* ============================================================ */}
      <div className="w-full border-t border-slate-100/90 bg-white py-8 sm:py-14 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-12">
          
          {/* Top: Eyebrow + Headline */}
          <div className="text-center max-w-2xl mx-auto space-y-2.5 sm:space-y-3 mb-4 sm:mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-[2rem] font-sans font-normal text-[#0F172A] tracking-tight leading-snug">
          ...
          {/* Directly Below Text: Glowing Cyber Brain Visual */}
          ...
          {/* 3 Clean Focus Areas with Thin Vertical Dividers */}
          <div className="max-w-3xl mx-auto grid grid-cols-3 gap-1 sm:gap-4 items-center border-t border-slate-100/90 pt-4 sm:pt-6">
            
            {/* Focus 1: Machine Learning */}
            <div className="text-center px-1 sm:px-3 py-2 space-y-1.5 sm:space-y-2.5">
            ...
            <div className="text-center px-1 sm:px-3 py-2 space-y-1.5 sm:space-y-2.5 border-l border-slate-200">
              <div className="w-8 h-8 sm:w-9 sm:h-9 mx-auto flex items-center justify-center text-[#0284C7]">
