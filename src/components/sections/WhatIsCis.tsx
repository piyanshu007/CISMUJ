...
export const WhatIsCis: React.FC = () => {
  return (
    <section className="relative w-full bg-white text-[#0F172A] overflow-hidden select-none">
      ...
      {/* ============================================================ */}
      {/* ==================================      {/* ============================================================ */}
      {/* PART 2: OUR FOCUS SECTION (Mobile: Below text; Laptop: Left of text) */}
      {/* ============================================================ */}
      <div className="w-full border-t border-slate-100/90 bg-white py-6 sm:py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-10 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
            ...
            {/* Cyber Brain Hero Visual: 
                - On Phone / Mobile: order-2 (appears directly BELOW the text)
                - On Laptop / Desktop: order-1 lg:col-span-4 (appears to the LEFT of the text)
            */}
            <div className="order-2 lg:order-1 lg:col-span-4 flex items-center justify-center">
              <motion.div
                ...
                className="w-full max-w-[340px] sm:max-w-[400px] flex items-center justify-center"
              >
                <CyberBrainVisual />
              </motion.div>
            </div>
            ...
            {/* Middle Column: Eyebrow + Headline
                - On Phone / Mobile: order-1 (appears on top ABOVE the brain)
                - On Laptop / Desktop: order-2 lg:col-span-4 (appears in the middle, to the RIGHT of the brain)
            */}
            <div className="order-1 lg:order-2 lg:col-span-4 space-y-2 sm:space-y-3 text-center lg:text-left">
            ...
            {/* Right Column: 3 Clean Focus Areas with Thin Vertical Dividers
                - On Phone / Mobile: order-3 (appears at the bottom below brain)
                - On Laptop / Desktop: order-3 lg:col-span-4 (appears to the right)
            */}
            <div className="order-3 lg:order-3 lg:col-span-4 grid grid-cols-3 gap-1 sm:gap-3 items-center pt-2 lg:pt-0">
