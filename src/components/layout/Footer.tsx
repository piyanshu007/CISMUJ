  ...
  return (
    <footer className="relative bg-slate-50 text-slate-600 font-sans text-xs select-none border-t border-slate-200 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden select-none opacity-[0.03]">
        <span className="font-display font-black text-[22vw] tracking-tighter text-[#0F172A] uppercase leading-none whitespace-nowrap">
          IEEE CIS
        </span>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-14">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3.5">
              <div className="relative w-12 h-12 rounded-2xl bg-white border border-slate-200 p-2 flex items-center justify-center shadow-xs">
                <img
                  src="/logo-mark.png"
              ...
              <div className="flex flex-col">
                <span className="font-display font-black tracking-tight text-[#0F172A] text-base leading-tight">
                  IEEE COMPUTATIONAL INTELLIGENCE SOCIETY
                </span>
                <span className="font-mono text-xs text-[#0284C7] font-bold tracking-wider uppercase mt-0.5">
            ...
            <div className="flex items-center gap-3 pt-2 font-mono text-xs">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white hover:bg-[#0284C7] text-slate-700 hover:text-white border border-slate-200 flex items-center justify-center transition-all duration-200 shadow-xs group"
          ...
          <div className="space-y-3 font-sans">
            <h4 className="text-[#0F172A] font-bold text-sm tracking-wide flex items-center gap-1.5">
            ...
            <ul className="space-y-2 text-slate-600 text-xs">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#0284C7] transition-colors flex items-center gap-1.5 group"
                >
                  IEEE Global
            ...
            <div className="space-y-3.5 text-xs text-slate-600 pt-1">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Chairperson, IEEE CIS MUJ</p>
                </div>
              </div>
